...
const UpdateModal = ({editBlogData, setEditBlogData}) => {
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box w-11/12 max-w-5xl">
                    <h3 className="font-bold text-lg">Edit Your Posted Blog</h3>
                    <div>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div class="flex justify-end mt-6 flex items-center gap-5">
                                <label htmlFor='my-modal-5'  class="md:px-8 px-8 py-1.5 md:py-2.5 leading-5 text-white transition-colors duration-300 transform bg-red-500 rounded-md hover:bg-red-600 focus:outline-none focus:bg-gray-600">Close</label>
                                <button type='submit' class="md:px-8 px-4 py-1.5 md:py-2.5 leading-5 text-white transition-colors duration-300 transform bg-green-700 rounded-md hover:bg-green-600 focus:outline-none focus:bg-gray-600">{loading ? <SmallSpinner /> : "Edit & Save"}</button>
                            </div>
                        </form>
                    </div>
                </div>
